// Adapted for the browser from Examples/Shaders/HybridRender.cs
// NOTE: retargeted to GLSL ES 1.00 (WebGL1): GLSL_VERSION 100 and glsl100 shader paths.
// WARNING: This example writes gl_FragDepth from a raymarch shader and uses a custom depth-texture
//          framebuffer to mix raymarch + rasterization. Depth writing and depth textures are
//          advanced GL features unlikely to work on WebGL1 (GLSL ES 1.00).
using System;

namespace Examples.Web;

public unsafe class ShadersHybridRender : IWebExample
{
