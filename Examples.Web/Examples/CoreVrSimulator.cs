// Adapted for the browser from Examples/Core/VrSimulator.cs
// NOTE: retargeted to GLSL ES 1.00 (WebGL1): distortion shader is loaded from the glsl100 folder
//       (resources/shaders/glsl100/distortion100.fs) instead of the desktop resources/distortion330.fs.
using System;

namespace Examples.Web;

public unsafe class CoreVrSimulator : IWebExample
{
