// Adapted for the browser from Examples/Shaders/WriteDepth.cs
// NOTE: retargeted to GLSL ES 1.00 (WebGL1): GLSL_VERSION 100 and glsl100 shader paths.
// WARNING: This example writes gl_FragDepth and uses a custom depth-texture framebuffer;
//          these are advanced GL features unlikely to work on WebGL1 (GLSL ES 1.00).
namespace Examples.Web;

public unsafe class ShadersWriteDepth : IWebExample
{
